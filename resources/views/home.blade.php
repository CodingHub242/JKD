            ...
            @forelse($projects as $project)
                <a href="{{ url('/projects/'.$project->slug) }}" class="project-card group reveal">
                    <div class="overflow-hidden">
                        <img src="{{ $project->cover_image ? asset('storage/'.$project->cover_image) : asset('slide1.jpg') }}" alt="{{ $project->title }}" class="project-card__img">
                    </div>
                    <div class="p-6">
                ...
                @foreach($testimonials as $t)
                    <div class="surface reveal p-7">
                        ...
                        <div class="mt-6 flex items-center gap-3">
                            @if($t->avatar)<img src="{{ asset('storage/'.$t->avatar) }}" alt="{{ $t->name }}" class="h-11 w-11 rounded-full object-cover">@endif
                            <div>
