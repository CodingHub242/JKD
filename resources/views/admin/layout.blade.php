...
<head>
    ...
    <title>{{ $title ?? 'Admin' }} · {{ $site['company_name'] ?? 'JKD PINNACLE CONSTRUCTION' }}</title>
...
<body x-data="{ sidebar: false }" class="bg-ink-950 text-ink-100 font-sans antialiased">
    ...
    <div class="flex min-h-screen">
        {{-- Sidebar --}}
        <aside style="background: linear-gradient(to bottom, #0c1426e5 10%, #0c1426e7 100%), url('{{asset('CEO.jpeg')}}') no-repeat center center / cover !important;"
